		...
		<!-- container -->
			...
			<div class="header header-border">
				<div class="container">
					<!-- logo -->
					<div class="logo">
						<a href="indexi.html"><img src="images/logo.png" title="medicalpluse" /></a>
					</div>
					<!-- logo -->
					<!-- top-nav -->
					<div class="top-nav">
								...
								<div class="col-md-9 services-left">
									...
									<div class="services-left-grids">
										<div class="col-md-6 services-left-grid">
											<h3>Pediatri</h3>
											<p>Kujdesi ndaj femijeve dhe te posalindurve,neonatalet etj</p>
											<a class="more-btn" href="#">More</a>
										</div>
										<div class="col-md-6 services-left-grid">
											<h3>Gjinekologji</h3>
											<p>Kontrrollat gjinekologjike,percjellje e shtazenis,kontrrolle pas lindjes etj </p>
											<a class="more-btn" href="#">More</a>
										</div>
										<div class="col-md-6 services-left-grid">
											<h3>Mjeksi e pergjithshme</h3>
											<p>Kontrrolla te pergjithshme mjeksore </p>
											<a class="more-btn" href="#">More</a>
										</div>
										<div class="col-md-6 services-left-grid">
											<h3>Stomatologji</h3>
											<p>Kontrrolla te pergjithshme dhe rregullime te dhembit </p>
											<a class="more-btn" href="#">More</a>
										</div>
										<div class="col-md-6 services-left-grid">
											<h3>Dermatologji (te shtunen)</h3>
											<p>Diagnostifikimi dhe trajtimi i semundjeve te lekures</p>
											<a class="more-btn" href="#">More</a>
										</div>
										<div class="col-md-6 services-left-grid">
											<h3>Oftamologji (te enjten) </h3>
											<p>Caktimi i dioptris etj</p>
											<a class="more-btn" href="#">More</a>
										</div>
										<div class="clearfix"> </div>
										<ul class="pagenation">
